...
function playAudio(recorderAudioAsBlob) {
    ...
    reader.onload = (e) => {
        ...
        convertBlobToWav(recorderAudioAsBlob);
...
// Assuming 'blob' is your Blob object representing the WebM audio
function convertBlobToWav(blob) {
    ...
    fileReader.onload = function() {
        ...
        audioContext.decodeAudioData(arrayBuffer, function(decodedData) {
            ...
            const wavBlob = exportWav(wavBuffer);
           
        // Heres where we will analyse it!
        const element = document.getElementById('upload-element');
        const uploadUrl = element.dataset.uploadUrl;
            ...
            // Now you can use the 'wavBlob' as needed (e.g., send it to the server)
